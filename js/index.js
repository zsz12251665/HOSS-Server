...
xhr.send();
JSON.parse(xhr.responseText).forEach(homework => document.querySelector('select#WorkTitle').innerHTML += Date.parse(homework.deadline + ' 23:59:59') > Date.now() ? '<option value="' + homework.directory + '">' + homework.title + ' (' + homework.deadline + ')</option>': '');
// Add event listeners
